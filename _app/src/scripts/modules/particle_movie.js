import fragmentShader from "../../public/assets/shader/particle_movies/fragmentShader.frag?raw";
import vertexShader from "../../public/assets/shader/particle_movies/vertexShader.vert?raw";

const particleMovie = (element) => {
  ...
  const init = () => {
    ...
    document.getElementById("particle_movie").appendChild(renderer.domElement);
  ...
  const initAudio = () => {
    ...
    audioLoader.load("/assets/audios/breakbot/baby_im_yours/musics.mp3", (buffer) => {
  ...
  const createParticles = () => {
    ...
    let colorsPerFace = ["#ffffff"];
    // let colorsPerFace = ["#23A7F3", "#E21E4F", "#F4CB06", "#111111", "#dddddd"];
